          ...
          <div className="col-span-12 xl:col-span-9 space-y-8">
            <div className="grid grid-cols-4 gap-4 mb-6">
              <div className="bg-[rgb(var(--card-bg))] border border-[rgb(var(--border))] rounded-xl p-5">
                ...
                <div className="text-3xl font-bold text-[rgb(var(--text))]">67%</div>
                <div className="text-xs mt-2 font-medium text-green-600 dark:text-[#4B8B4B]">↑ 12% vs Q1</div>
              </div>
              <div className="bg-[rgb(var(--card-bg))] border border-[rgb(var(--border))] rounded-xl p-5">
                <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Goals on track</div>
                <div className="text-3xl font-bold text-[rgb(var(--text))]">38</div>
                <div className="text-xs mt-2 font-medium text-green-600 dark:text-[#4B8B4B]">↑ 5 since last quarter</div>
              </div>
              <div className="bg-[rgb(var(--card-bg))] border border-[rgb(var(--border))] rounded-xl p-5">
                <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Check-ins done</div>
                <div className="text-3xl font-bold text-[rgb(var(--text))]">4 <span className="text-sm text-gray-500 font-medium">/ 5</span></div>
                <div className="text-xs mt-2 font-medium text-gray-500 dark:text-gray-400">Q2 in progress</div>
              </div>
              <div className="bg-[rgb(var(--card-bg))] border border-[rgb(var(--border))] rounded-xl p-5">
                <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Escalations open</div>
                <div className="text-3xl font-bold text-[rgb(var(--text))]">2</div>
                <div className="text-xs mt-2 font-medium text-red-600 dark:text-[#D14F4F]">↑ 1 new this week</div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-[rgb(var(--card-bg))] border border-[rgb(var(--border))] rounded-2xl p-8 shadow-xl">
                ...
                <div className="grid grid-cols-[80px_repeat(4,1fr)] gap-3">
                  ...
                  {/* Tech */}
                  <div className="flex items-center text-sm font-bold text-gray-500 mt-2">Tech</div>
                  <div className="bg-[#2D2A1F] shadow-[inset_0_2px_15px_rgba(153,203,107,0.1),0_4px_6px_-1px_rgba(0,0,0,0.5)] border border-[#4A452F] rounded-lg p-3 text-center text-sm font-black text-[#BDE58A] transform hover:-translate-y-1 transition-transform cursor-pointer mt-2">60%</div>
                  <div className="bg-[#3D3A2F] shadow-[inset_0_2px_15px_rgba(193,229,156,0.1),0_4px_6px_-1px_rgba(0,0,0,0.5)] border border-[#5A553F] rounded-lg p-3 text-center text-sm font-black text-[#E8F5D6] transform hover:-translate-y-1 transition-transform cursor-pointer mt-2">42%</div>
                  <div className="bg-[#1A1A1A] border border-[#333] rounded-lg p-3 text-center text-sm font-black text-[#444] shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] mt-2">—</div>
                  <div className="bg-[#1A1A1A] border border-[#333] rounded-lg p-3 text-center text-sm font-black text-[#444] shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] mt-2">—</div>

                  {/* Finance */}
                  <div className="flex items-center text-sm font-bold text-gray-500 mt-2">Finance</div>
                  <div className="bg-[#1C3524] shadow-[inset_0_2px_15px_rgba(75,139,75,0.5),0_4px_6px_-1px_rgba(0,0,0,0.5)] border border-[#2F5234] rounded-lg p-3 text-center text-sm font-black text-[#A3F0A3] transform hover:-translate-y-1 transition-transform cursor-pointer mt-2">88%</div>
                  <div className="bg-[#1C3524] shadow-[inset_0_2px_15px_rgba(75,139,75,0.3),0_4px_6px_-1px_rgba(0,0,0,0.5)] border border-[#2F5234] rounded-lg p-3 text-center text-sm font-black text-[#85E085] transform hover:-translate-y-1 transition-transform cursor-pointer mt-2">74%</div>
                  <div className="bg-[#1A1A1A] border border-[#333] rounded-lg p-3 text-center text-sm font-black text-[#444] shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] mt-2">—</div>
                  <div className="bg-[#1A1A1A] border border-[#333] rounded-lg p-3 text-center text-sm font-black text-[#444] shadow-[inset_0_2px_4px_rgba(0,0,0,0.5)] mt-2">—</div>
                </div>
              </div>
            ...
            <div className="bg-[rgb(var(--card-bg))] border border-[rgb(var(--border))] rounded-xl p-6">
              <h2 className="text-sm font-bold text-[rgb(var(--text))] mb-6">Individual progress — Q2 snapshot</h2>
              
              <div className="grid grid-cols-2 gap-x-12 gap-y-6">
                {[
                  { initials: 'AS', name: 'Arjun Singh', score: 78, color: 'bg-[#4B8B4B]', avatarBg: 'bg-[#EAF2FF] dark:bg-[#1A263B] text-[#2D66C2] dark:text-[#7DAAEE]' },
                  { initials: 'NP', name: 'Neha Patel', score: 65, color: 'bg-[#4B8B4B]', avatarBg: 'bg-[#E2F5E2] dark:bg-[#1E3624] text-[#2F6B2F] dark:text-[#5BAE5B]' },
                  { initials: 'VR', name: 'Vikram Rao', score: 41, color: 'bg-[#D17D31]', avatarBg: 'bg-[#FFF3E0] dark:bg-[#3D2614] text-[#B05B1E] dark:text-[#E08A4E]' },
                  { initials: 'SD', name: 'Shreya Desai', score: 88, color: 'bg-[#4B8B4B]', avatarBg: 'bg-[#F3F4F6] dark:bg-[#333] text-[#374151] dark:text-[#D1D5DB]' },
                  { initials: 'KJ', name: 'Karan Joshi', score: 53, color: 'bg-[#D17D31]', avatarBg: 'bg-[#FBEAF0] dark:bg-[#381622] text-[#B8305A] dark:text-[#E8678F]' },
                ].map((emp, i) => (
            ...
            <div className="sticky top-[100px] bg-[#0A0A0A] border border-[#222] rounded-2xl p-6 shadow-[0_0_40px_rgba(0,0,0,0.8)] overflow-hidden relative">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-red-500">2 Alerts</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <motion.div 
                  ...
                  className="bg-[#1A1111] border border-[#331818] p-4 rounded-xl relative group"
                >
                  <div className="absolute -left-px top-4 bottom-4 w-0.5 bg-red-500 opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="text-xs font-bold text-red-400 mb-1">Missed Check-in</div>
                  <div className="text-sm text-gray-300 font-medium">Vikram Rao (Product)</div>
                  <div className="text-xs text-gray-500 mt-2">12 mins ago</div>
                </motion.div>
                ...
                >
                  <div className="absolute -left-px top-4 bottom-4 w-0.5 bg-red-500 opacity-0 group-hover:opacity-100 transition-opacity" />
                  <div className="text-xs font-bold text-red-400 mb-1">Goal at Risk</div>
                  <div className="text-sm text-gray-300 font-medium">Ops Efficiency Target</div>
                  <div className="text-xs text-gray-500 mt-2">1 hour ago</div>
                </motion.div>
                ...
                >
                  ...
                  <div className="text-sm text-gray-300 font-medium">Shreya Desai (Design)</div>
                  <div className="text-xs text-gray-500 mt-2">3 hours ago</div>
                </motion.div>
